...
const megaTemplateObj = {
    ...
    templateObj_300dc: {
        ...
        <table class="spacer" style="border-collapse: collapse; border-spacing: 0; padding: 0; text-align: left; vertical-align: top; width: 100%;"><tbody><tr style="padding: 0; text-align: left; vertical-align: top;"><td height="birch_socialSpacerBottom_birchpx" style="Margin: 0; border-collapse: collapse !important; color: #2E2E2E; font-family: Helvetica, Arial, sans-serif; font-size: birch_socialSpacerBottom_birchpx; font-weight: normal; line-height: birch_socialSpacerBottom_birchpx; margin: 0; mso-line-height-rule: exactly; padding: 0; text-align: left; vertical-align: top;">&#xA0;</td></tr></tbody></table>`,
            ...
            socialUrlTwitter: 'https://github.com/unumux/birch-builder-2/blob/master/images/components/unum-icon-twitter-light.png?raw=true',
            socialUrlFacebook: 'https://github.com/unumux/birch-builder-2/blob/master/images/components/unum-icon-facebook-light.png?raw=true',
            socialUrlLinkedin: 'https://github.com/unumux/birch-builder-2/blob/master/images/components/unum-icon-linkedin-light.png?raw=true',
            socialUrlTwitterLight: 'https://github.com/unumux/birch-builder-2/blob/master/images/components/unum-icon-twitter-light.png?raw=true',
            socialUrlTwitterDark: 'https://github.com/unumux/birch-builder-2/blob/master/images/components/unum-icon-twitter-dark.png?raw=true',
            socialUrlFacebookLight: 'https://github.com/unumux/birch-builder-2/blob/master/images/components/unum-icon-facebook-light.png?raw=true',
            socialUrlFacebookDark: 'https://github.com/unumux/birch-builder-2/blob/master/images/components/unum-icon-facebook-dark.png?raw=true',
            socialUrlLinkedinLight: 'https://github.com/unumux/birch-builder-2/blob/master/images/components/unum-icon-linkedin-light.png?raw=true',
            socialUrlLinkedinDark: 'https://github.com/unumux/birch-builder-2/blob/master/images/components/unum-icon-linkedin-dark.png?raw=true',
            socialSpacerBottom: '20',
...
const main = {
    ...
    goEdit: function(compId, el, evt){ // enter edit mode for a component in the email
        ...
        if (receivedTemplateId == 'templateObj_200dc'){
            ...
            document.querySelector('#t200dc_imageCompAltTextColor').value = matchingDataComp.templateValuesObj.imageCompAltTextColor
            document.querySelector('#t200dc_imageCompSpacerBottom').value = matchingDataComp.templateValuesObj.imageCompSpacerBottom
...
const handlers = {
    ...
    goSavet200dc: function(){ // enter edit mode for a component in the email
        ...
        selectedComp.templateValuesObj.imageCompAltTextColor = document.querySelector('#t200dc_imageCompAltTextColor').value
        selectedComp.templateValuesObj.imageCompSpacerBottom = document.querySelector('#t200dc_imageCompSpacerBottom').value
...
function mergeDataIntoPlaceholders(templateBaseCode, templateDataObj){
    ...
    for (const [fieldLabel, fieldData] of templateDataObjEntries) {
        ...
        if (fieldLabel === 'imageCompUrl'){
            if (templateDataObj.imageCompUrl == ''){ // remove the placeholder
                ...
                if (templateDataObj.alignment == 'center'){
                    baseCodeWithDynamicCodeInserted = baseCodeWithDynamicCodeInserted.replace(`birch_imageCompCode_birch`, templateDataObj.centerBlockStart + templateDataObj.imageCompCode + templateDataObj.centerBlockEnd)
                }
